...
class ProdutoResource(resources.ModelResource):
    ...
    class Meta:
        model = Produto
        fields = ('id', 'nome', 'codigo_barras', 'carteiras_por_caixa','categoria_nome', 'preco_compra', 'preco_venda','preco_carteira', 'estoque_minimo','controlado')
        export_order = ('id', 'nome', 'codigo_barras', 'carteiras_por_caixa','categoria_nome', 'preco_compra', 'preco_venda','preco_carteira','controlado')
